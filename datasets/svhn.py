...
class SVHN(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.test_sample_dir = os.path.join(self.dataset_dir, 'sampled_test')
        self.split_path = os.path.join(self.dataset_dir, "split_mlai_SVHN.json")
        self.split_fewshot_dir = os.path.join(self.dataset_dir, 'split_fewshot')
        mkdir_if_missing(self.split_fewshot_dir)

        if cfg.TEST.SAMPLE.isdigit():

            test = self.read_sampled_data(self.test_sample_dir, f"sampled_{cfg.TEST.SAMPLE}")
    ...
    def read_sampled_data(self, test_image_dir, sample):
        sampled_dir = os.path.join(test_image_dir, f"{sample}")
        print(f"Reading sampled test data from {sampled_dir}")

        categories = listdir_nohidden(sampled_dir)
        categories.sort()
        ...
        for label, category in enumerate(categories):
            category_dir = os.path.join(sampled_dir, category)
